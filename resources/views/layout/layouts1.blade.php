...
<head>
    ...
    <title>PT. Tri Plastik | Pemilik</title>
...
<body class="nav-md">
    <div class="container body">
        <div class="main_container">
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="{{url('pemilik/')}}" class="site_title"><i class="fa fa-recycle"></i> <span>PT. Tri Plastik</span></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="{{ url('pemilik/barang') }}"><i class="fa fa-laptop"></i> Barang</a></li>
                                <li><a><i class="fa fa-toggle-left"></i> Bahan Baku<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{ url('/pemilik/pembelian'); }}">Pembelian Bahan Baku</a></li>
                                        <li><a href="{{ url('/pemilik/pembelian/bahanbaku'); }}">Bahan Baku</a></li>
                                        <li><a href="{{ url('/pemilik/pembelian/historibahanbaku'); }}">Histori Bahan Baku</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-toggle-right"></i> Barang Jadi<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{url('/pemilik/penjualan/barangjadi')}}">Barang Jadi</a></li>
                                        <li><a href="{{url('/pemilik/penjualan/historibarangjadi')}}">Histori Barang Jadi</a></li>
                                        <li><a href="{{url('/pemilik/penjualan/')}}">Penjualan Barang Jadi</a></li>
                                    </ul>
                                </li>
            ...
            <!-- footer content -->
            <footer>
                <div class="pull-right">PT.Tri Plastik
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
    ...
    <!-- jQuery Sparklines -->
    <script src="../bootstrap/vendors/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
    <!-- Flot -->
