                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('sekretaris/barang/edit',$data->id_barang) }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                            <form method="post" action="{{ url('sekretaris/barang/destroy', $data->id_barang) }}">
                                                @csrf
                                                @method("DELETE")
